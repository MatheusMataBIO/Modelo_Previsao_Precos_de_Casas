# Enunciado preservado do README
...
- `../data/raw/kc_house_data.csv`: informações físicas dos imóveis **com preço**.  
- `../data/raw/zipcode_demographics.csv`: dados **demográficos** agregados por código postal.  
- `../data/raw/future_unseen_examples.csv`: informações de imóveis **sem preço**, que devem ser utilizadas para prever os valores após o treinamento.
